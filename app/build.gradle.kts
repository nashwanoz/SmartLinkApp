...
android {
  ...
  // Ensure debug.keystore exists from base64 if needed (e.g. CI environments / GitHub Actions)
  ...
  buildTypes {
    release {
      ...
      signingConfig = if (releaseKeystore.exists() && System.getenv("STORE_PASSWORD") != null) {
